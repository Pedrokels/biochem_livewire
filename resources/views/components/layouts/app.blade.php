...
<head>
    ...
    <!-- CONSOLIDATION FILE INPUT CSS -->
    <link id="pagestyle" href="{{ asset('assets/css/ConsolidationInputDesign.css/consolidationinput.css') }}"
        rel="stylesheet" />
...
<body class="g-sidenav-show dark-version">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">
                            @if (request()->is('/'))
                                Dashboard
                            @elseif (request()->is('consolidation'))
                                Consolidation
                            @else
                                <!-- Default or other route handling -->
                            @endif
                        </li>
    ...
    <script src="{{ asset('assets/js/ConsolidationInputJs/ConsolidationInputJs.js') }}"></script>
